...
## ⬆️ Этап 15: Кнопка подъёма наверх (ScrollToTop)

**Цель:** Добавить кнопку плавного скролла наверх при прокрутке страницы

### Задачи

- [x] 15.1 Создать components/ui/ScrollToTop.tsx (Client Component)
  ...
  - Акцентный цвет teal
- [x] 15.2 Интегрировать ScrollToTop в ClientShell
  - Добавлен в ClientShell.tsx после ToastRenderer
- [x] 15.3 Написать тесты
...
- [ ] 16.3 Проверить персистентность
...
| 15. ScrollToTop | ✅ Завершён | Круглая кнопка со стрелкой, порог 100px, 81 тест |
| 16. Полировка | ⬜ Не начат | |
